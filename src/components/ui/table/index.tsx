                  ...
                  >
                    {columns.map((column) => (
                      <td
                        ...
                        data-key={column.key}
                        data-index={index}
                        className={`${styles["border"]} ${changedCellKeys.has(`${index}-${column.key}`) || row['modified'] ? styles.modified : ''}`}
                    ...
                    {editable && <td className={`${styles["action-container"]} ${row['modified'] ? styles.modified : ''}`}>
